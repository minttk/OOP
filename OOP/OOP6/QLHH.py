...
class HangHoa(ABC):
    ...
    def inTTin(self):
        return (f"[{self.loai_hang()}] Mã: {self.__ma_hang}"
                f" | {self.__ten_hang} | NSX: {self.__nha_sx}"
...
sp1 = HangDienMay("AB01", "Máy Giặt", "LG", 30_000_000, 20, 320, 250)
sp2 = HangSanhSu("KO01", "Máy chơi game", "nintendo", 7_000_000)
sp3 = HangThucPham("HL01", "Bánh Quy", "Danisa", 32_000, "2026-04-01", "2026-09-01")
